      ...
      <div className="p-3">
        <div className="card">
          <div className="card-body">
            <h5 className="card-title">메뉴1 조회</h5>
            <p className="card-text">여기에 메뉴1 조회 콘텐츠가 표시됩니다.</p>
            <ul className="list-group list-group-flush">
              <li className="list-group-item">항목 ID: CS001</li>
              <li className="list-group-item">상태: 처리 중</li>
              <li className="list-group-item">날짜: 2025-05-20</li>
              <li className="list-group-item">담당자: 김철수</li>
            </ul>
          </div>
        </div>
      </div>
...
export default MobileCsDetails;